...
public class ManagementResourceFromEntityAssembler {
    ...
    public static ManagementResource toResourceFromEntity(Management entity) {
        return new ManagementResource(
                ...
                entity.getContactResult() != null ? entity.getContactResult().getCode() : null,
                entity.getContactResult() != null ? entity.getContactResult().getDescription() : null,
                entity.getManagementType() != null ? entity.getManagementType().getCode() : null,
                entity.getManagementType() != null ? entity.getManagementType().getDescription() : null,
                entity.getManagementType() != null ? entity.getManagementType().getRequiresPayment() : null,
                entity.getManagementType() != null ? entity.getManagementType().getRequiresSchedule() : null,
