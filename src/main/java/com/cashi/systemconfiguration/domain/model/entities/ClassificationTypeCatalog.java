...
/**
 * ClassificationTypeCatalog - Catálogo de tipos de clasificación
 * Define los comportamientos y características de cada tipo de clasificación
 * (Pagos, Cronogramas, Reclamos, etc.)
 */
@Entity
@Table(name = "catalogo_tipos_clasificacion", indexes = {
...
@Setter
@NoArgsConstructor
public class ClassificationTypeCatalog {
    ...
    public ClassificationTypeCatalog(String category, String code, String name, String description) {
    ...
    public ClassificationTypeCatalog(String category, String code, String name, String shortName,
